...
fn modpow_right_to_left_noshift(
    base: &BigInteger,
    exponent: &BigInteger,
    modulus: &BigInteger,
) -> BigInteger {
...
benchmark_group!(gcd, bench_gcd_euclidean);
...
benchmark_group!(mulrem, bench_mulrem_naive, bench_mulrem_montgomery);
...
benchmark_group!(mont, bench_mont_naive, bench_mont_montgomery);
